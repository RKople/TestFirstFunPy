...
public class MainActivity extends Activity {
    ...
    private void build(){
        ...
        top.addView(heading, new LinearLayout.LayoutParams(0,-2,1)); top.addView(Ui.pill(this, "v1.7", false)); root.addView(top);
    ...
    private void refresh(){
        ...
        if(automationNote!=null)automationNote.setText("Réveil : "+AppState.preWakeMinutes(this)+" min avant avec exactement le mécanisme du test Wake-up validé. Dès que la TV s’allume, un écran d’attente affiche le compte à rebours puis Plex démarre à l’heure prévue. Extinction Philips : "+(PhilipsTvClient.isPaired(this)?"prête ✓":"à associer dans Tests")+". Laisse activées “Alarmes exactes” et “Activation de l’écran”.");
    }
